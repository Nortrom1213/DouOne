...
def create_optimizers(flags, learner_model):
    """
    Create three optimizers for the three positions based on the chosen optimizer type.
    """
    positions = ['landlord', 'landlord_up', 'landlord_down']
    optimizers = {}
    for position in positions:
        params = learner_model.parameters(position)
        if flags.optimizer == 'rmsprop':
            ...
            raise ValueError("Unsupported optimizer: {}".format(flags.optimizer))
